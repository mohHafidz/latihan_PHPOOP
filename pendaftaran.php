...
if(isset($_POST['add']))
{
	$db->tambah_data($_POST['nama'],$_POST['tanggal_lahir'],$_POST['tempat_lahir'],$_POST['warga_negara'],$_POST['alamat'],$_POST['email'],$_POST['tlp'],$_POST['smp'],$_POST['ayah'],$_POST['ibu'],$_POST['penghasilan']);
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form class="px-md-2" method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="form-outline mb-4">
                <input type="text" id="form3Example1q" name="nama" class="form-control" />
